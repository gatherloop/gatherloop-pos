...
export type RentalCheckinCartViewProps = {
...
export const RentalCheckinCartView = ({
  form,
  rentalsFieldArray,
  tickets,
            ...
            <XStack>
              <XStack width={300} alignItems="center" gap="$4">
                <Checkbox
                  ...
                  onCheckedChange={onToggleCustomizeCheckinDateTime}
                >
                  <Checkbox.Indicator>
                    <Check />
                  </Checkbox.Indicator>
          ...
          <YStack key={key} gap="$3">
            ...
            >
              <XStack gap="$3">
                ...
                />
                <YStack>
                  <Paragraph size="$5">{variant.product.name}</Paragraph>
                  <Paragraph>
                    {variant.values
            ...
            />
            <FieldWatch control={form.control} name={[`rentals.${index}.code`]}>
              {([code]) => {
                if (!code) return null;
                ...
                return ticket ? (
                  <XStack alignItems="center" gap="$2">
                    ...
                    <Paragraph color="$green10">→ {ticket.name}</Paragraph>
                  </XStack>
                ) : (
                  <XStack alignItems="center" gap="$2">
                    <AlertCircle size="$1" color="$yellow10" />
                    <Paragraph color="$yellow10">Unregistered card</Paragraph>
                  </XStack>
                );
              }}
            </FieldWatch>
