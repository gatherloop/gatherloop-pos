...
export const ProductMaterialDeleteAlert = ({
  ...
  const { onButtonConfirmPress, status } = useProductMaterialDeleteAlertState({
    productId,
    productMaterialId,
    onSuccess,
  });
  return (
    <AlertDialog native open onOpenChange={onCancel} modal>
      <AlertDialog.Portal>
        ...
        >
          <YStack gap="$3">
            <AlertDialog.Title>Delete Product Material</AlertDialog.Title>
            <AlertDialog.Description>
              Are you sure want to delete the product material ?
            </AlertDialog.Description>
