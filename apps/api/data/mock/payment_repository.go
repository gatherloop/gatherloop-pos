...
// Source: domain/payment_repository.go
//
// Generated by this command:
//
//	mockgen -source=domain/payment_repository.go -destination=data/mock/payment_repository.go -package=mock
//
...
// CancelQris mocks base method.
func (m *MockPaymentGatewayRepository) CancelQris(ctx context.Context, input domain.CancelQrisInput) *domain.Error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "CancelQris", ctx, input)
	ret0, _ := ret[0].(*domain.Error)
	return ret0
}

// CancelQris indicates an expected call of CancelQris.
func (mr *MockPaymentGatewayRepositoryMockRecorder) CancelQris(ctx, input any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CancelQris", reflect.TypeOf((*MockPaymentGatewayRepository)(nil).CancelQris), ctx, input)
}
