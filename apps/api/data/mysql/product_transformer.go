...
func ToProductDB(domainProduct domain.Product) Product {
	return Product{
		...
		IsAvailable:          domainProduct.IsAvailable,
		AvailabilityTracking: string(domainProduct.AvailabilityTracking),
		AvailableQuantity:    domainProduct.AvailableQuantity,
	}
}
...
func ToProductDomain(dbProduct Product) domain.Product {
	return domain.Product{
		...
		AvailabilityTracking: domain.AvailabilityTracking(dbProduct.AvailabilityTracking),
