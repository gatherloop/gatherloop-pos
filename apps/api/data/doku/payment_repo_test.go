...
const testNotificationClientSecret = "test-client-secret"
...
func TestVerifyNotificationSignature_Valid(t *testing.T) {
	...
	signature, sigErr := signSymmetric(testNotificationClientSecret, method, path, "", body, timestamp)
	require.NoError(t, sigErr)

	err := VerifyNotificationSignature(testNotificationClientSecret, method, path, domain.NotificationHeaders{
		Timestamp: timestamp,
		Signature: signature,
...
func TestVerifyNotificationSignature_TamperedBody(t *testing.T) {
	...
	signature, sigErr := signSymmetric(testNotificationClientSecret, method, path, "", originalBody, timestamp)
	require.NoError(t, sigErr)
...
func TestVerifyNotificationSignature_TamperedSignature(t *testing.T) {
	...
	err := VerifyNotificationSignature(testNotificationClientSecret, "POST", "/payments/doku/notification", domain.NotificationHeaders{
		Timestamp: timestamp,
...
func TestVerifyNotificationSignature_ClockSkewRejected(t *testing.T) {
	...
	signature, sigErr := signSymmetric(testNotificationClientSecret, method, path, "", body, staleTimestamp)
	require.NoError(t, sigErr)
