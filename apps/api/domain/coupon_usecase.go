...
func (usecase CouponUsecase) CreateCoupon(ctx context.Context, coupon Coupon) *Error {
	return usecase.repository.CreateCoupon(ctx, &coupon)
}

func (usecase CouponUsecase) UpdateCouponById(ctx context.Context, coupon Coupon, id int64) *Error {
