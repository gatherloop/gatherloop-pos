...
func (usecase MaterialUsecase) GetMaterialList(ctx context.Context, query string, sortBy SortBy, order Order, skip int, limit int) ([]Material, int64, *Error) {
	...
	for index, material := range materials {
		...
		if material.Suppliers == nil {
			material.Suppliers = []MaterialSupplier{}
		}
...
func (usecase MaterialUsecase) CreateMaterial(ctx context.Context, material Material) (Material, *Error) {
	...
	if err := usecase.repository.SetMaterialSuppliers(ctx, createdMaterial.Id, material.Suppliers); err != nil {
		return Material{}, err
	}
	...
	if createdMaterial.Suppliers == nil {
		createdMaterial.Suppliers = []MaterialSupplier{}
	}
...
func (usecase MaterialUsecase) UpdateMaterialById(ctx context.Context, material Material, id int64) (Material, *Error) {
	...
	if err := usecase.repository.SetMaterialSuppliers(ctx, id, material.Suppliers); err != nil {
		return Material{}, err
	}
	...
	if updatedMaterial.Suppliers == nil {
		updatedMaterial.Suppliers = []MaterialSupplier{}
	}
