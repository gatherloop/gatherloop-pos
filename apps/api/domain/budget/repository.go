...
type Repository interface {
	...
	CreateBudget(ctx context.Context, budgetRequest BudgetRequest) *base.Error
	UpdateBudgetById(ctx context.Context, budgetRequest BudgetRequest, id int64) *base.Error
