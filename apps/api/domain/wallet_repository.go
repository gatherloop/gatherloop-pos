...
type WalletRepository interface {
	...
	UpdateWalletById(ctx context.Context, wallet *Wallet, id int64) *Error
	...
	CreateWalletTransfer(ctx context.Context, walletTransfer *WalletTransfer, fromWalletId int64) *Error
}
