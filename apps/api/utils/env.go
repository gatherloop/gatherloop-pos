...
func GetEnv() Env {
	...
	return Env{
		...
		CodVerificationExpirySeconds: parseIntWithDefault(os.Getenv("COD_VERIFICATION_EXPIRY_SECONDS"), 900),
		...
		OrderCodPaymentEnabled:       parseBoolWithDefault(os.Getenv("ORDER_COD_PAYMENT_ENABLED"), false),
