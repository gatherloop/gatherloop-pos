...
func (usecase Usecase) GetProductList(query string, sortBy string, order string, skip int, limit int) ([]apiContract.Product, error) {
	return usecase.repository.GetProductList(query, sortBy, order, skip, limit)
}
