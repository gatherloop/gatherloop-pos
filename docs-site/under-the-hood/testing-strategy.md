...
- **Frontend:** 47 handler test files under [`libs/ui/src/presentation/screens`](https://github.com/gatherloop/gatherloop-pos/tree/main/libs/ui/src/presentation/screens) (split into `screens/pos` and `screens/order`, one per app), e.g. [`TransactionListHandler.test.tsx`](https://github.com/gatherloop/gatherloop-pos/blob/main/libs/ui/src/presentation/screens/pos/TransactionListHandler.test.tsx).
