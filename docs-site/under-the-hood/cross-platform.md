...
| Concern | Web (`apps/pos-web`) | Mobile (`apps/mobile`) |
|---|---|---|
| Routing | Next.js file-based pages under `apps/pos-web/src/pages` | React Navigation's `NativeStackNavigator`, configured in [`App.tsx`](https://github.com/gatherloop/gatherloop-pos/blob/main/apps/mobile/src/app/App.tsx) |
